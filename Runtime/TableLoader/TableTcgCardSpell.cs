...
{
    /// <summary>
    /// Spell 타입 카드의 능력(Ability) 정의를 담는 상세 테이블 행(row) 데이터입니다.
    /// 일반적으로 즉시 발동되는 일회성 효과를 표현하며,
    /// <see cref="ITcgCardAbilityRow"/> 계약에 따라 능력 구성 요소를 제공합니다.
    /// </summary>
    public sealed class StruckTableTcgCardSpell : ITcgCardAbilityRow
    {
        ...
        /// <summary>스펠 카드가 가지는 능력의 종류입니다.</summary>
        ...
        /// <summary>
        /// 능력 파라미터 A입니다.
        /// TODO: AbilityType에 따라 의미(예: 효과 수치, 횟수, 턴 수 등)가 달라질 수 있습니다.
        /// </summary>
