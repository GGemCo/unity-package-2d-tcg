...
namespace GGemCo2DTcg
{
    ...
    /// </summary>
    public sealed class TcgBattleContext
    {
        public GGemCoTcgSettings Settings { get; }

        public TcgBattleSideState Player { get; }
        public TcgBattleSideState Enemy  { get; }
        ...
        /// </summary>
        public TcgBattleSideState GetSideState(ConfigCommonTcg.TcgPlayerSide side)
        {
            return side == ConfigCommonTcg.TcgPlayerSide.Player ? Player : Enemy;
        }

        public TcgBattleSideState GetOpponentState(ConfigCommonTcg.TcgPlayerSide side)
        {
