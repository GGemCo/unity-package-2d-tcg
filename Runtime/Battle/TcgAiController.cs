...
namespace GGemCo2DTcg
{
    ...
    /// </summary>
    public sealed class TcgAiController : ITcgPlayerController
    {
        ...
        private TcgBattleSideState _me;
        private TcgBattleSideState _opponent;

        public TcgAiController(
        ...
        {
            _context = context;
            _me = context.GetSideState(Side);
            _opponent = context.GetOpponentState(Side);
        }
